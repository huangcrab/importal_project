...
import { addEmployment } from "../../actions/profileActions";
...
class AddEmployment extends Component {
  ...
  onSubmit = e => {
    ...
    this.props.addEmployment(expData, this.props.history);
  };
  onChange = e => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <h1 className="display-4 text-center">Add Employment</h1>
              <p className="lead text-center">Add any employments</p>
